    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute top-3 right-3 rounded-md p-1 text-muted-foreground outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:ring-3 focus-visible:ring-ring/50"
        >
