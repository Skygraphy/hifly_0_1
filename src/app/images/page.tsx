...
export default async function ImagesPage() {
  ...
  const initialResult = await searchImages({
    ...
    tagsQuery: "",
    offset: 0,
    // Muss mit dem Default-State in ImagesPageClient (sortBy) übereinstimmen,
    // sonst weicht die erste Server-gerenderte Reihenfolge vom Client ab.
    sortBy: "address-asc",
  });
